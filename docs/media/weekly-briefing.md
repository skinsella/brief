...
Updated: Mon, 20 Jul 2026 22:09 GMT

## Snapshot

- Recent coverage: 89 item(s) in the last 7 days.
- Weighted net framing: -1% (supportive minus critical, reach/significance-weighted).
- Significant items: 19.

## Trend Summary

- Coverage volume: 89 item(s) in the last 7 days; unchanged vs previous 7 days.
...
- [active] Government confirms increased tax credit for large-scale VFX work — 3 item(s), 2 outlet(s), 1 in 6h, 3 in 24h, net 0%. Outlets: IFTN, iftn.ie
